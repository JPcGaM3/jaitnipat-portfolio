...
export const profile: Profile = {
  ...
  photo:
    "https://lh3.googleusercontent.com/d/1BHmDfSJh6Rxb2LRpmnY-tEPnv85Sifxe",
};
...
export const projects: Project[] = [
  {
    ...
    description: [
      "React + Vite portfolio with dark-theme UI, project filters, and PWA-ready navigation.",
    ],
    vertical: "Web",
    year: 2025,
    ...
    media: {
      type: "video",
      src: "https://drive.google.com/file/d/1Nv6vzdS4zIhVz4AsLHSsrz7D8Xnr-km8/view?usp=sharing",
      alt: "Preview of the portfolio webapp",
    },
    githubUrl: ["https://github.com/JPcGaM3/jaitnipat-portfolio"],
  },
  {
    ...
    linkUrl: [
      "https://www.instagram.com/p/DF7jLCVSZL0/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
    ],
  },
  {
    id: "cbe-website-2024",
