    ...
    >
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-6 lg:flex-row lg:items-center">
        <div className="order-1 flex flex-1 justify-center lg:order-2">
          <div
            id="profile"
            className="relative h-56 w-56 overflow-hidden rounded-3xl border border-slate-800 bg-slate-900/80 shadow-2xl shadow-indigo-900/40"
          >
            <img src={profile.photo} alt={profile.name} className="h-full w-full object-cover" loading="lazy" />
          </div>
        </div>
        <div className="order-2 space-y-5 lg:order-1 lg:w-2/3">
