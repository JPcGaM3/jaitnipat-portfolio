    ...
    <section id="contact" className="border-t border-slate-800 bg-slate-900/40 py-16">
      <div className="mx-auto flex max-w-4xl flex-col gap-8 px-6 text-slate-200 md:flex-row md:items-center">
        <div className="space-y-4 md:w-2/3">
          ...
          <h2 className="text-3xl font-semibold text-white">Ready for internships and startup collabs.</h2>
          <p>
            I’m a 3rd-year Computer Engineering student looking to contribute to fast-moving teams. If you need someone who can
            prototype quickly, connect APIs, and ship UI updates without hand-holding, let’s talk.
          </p>
        </div>
        <div className="flex-1 space-y-3 text-sm">
          ...
          <p className="text-slate-400">Bangkok · UTC+7 · Open to remote and hybrid internships</p>
        </div>
      </div>
    </section>
  );
